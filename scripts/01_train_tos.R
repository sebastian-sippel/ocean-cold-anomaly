  ...
  foreach(date.ix=1:171) %dopar% {   # date.ix = 122
    ...
    # 4.1 Predict GSAT:  
    {
        ...
        save(list = c("mod_p0", "mod_p1", "mod_gta", "CMIP6.df"), 
             file = paste("/net/h2o/climphys1/sippels/_projects/ocean-cold-anomaly/data/02_trained_models/tos_predGSAT/", 
    ...
    # 4.2 Predict GMST:  
    {
      ...
      # save models for given time step:
      save(list = c("mod_p0", "mod_p1", "mod_gta", "CMIP6.df"), 
           file = paste("/net/h2o/climphys1/sippels/_projects/ocean-cold-anomaly/data/02_trained_models/tos_predGMST/", 
                        format(HadSST4_calendar_[date.ix], "%Y"), "-", format(HadSST4_calendar_[date.ix], "%m"), ".RData", sep=""))
    }
    ...
    # 4.4 Predict GMLSAT_NI:  
    {
      ...
      # save models for given time step:
      save(list = c("mod_p0", "mod_p1", "mod_gta", "CMIP6.df"), 
           file = paste("/net/h2o/climphys1/sippels/_projects/ocean-cold-anomaly/data/02_trained_models/tos_predGMLSAT_NI/", 
                        format(HadSST4_calendar_[date.ix], "%Y"), "-", format(HadSST4_calendar_[date.ix], "%m"), ".RData", sep=""))
    }
    ...
    # 4.5 Predict GMSST:  
    {
      ...
      # save models for given time step:
      save(list = c("mod_p0", "mod_p1", "mod_gta", "CMIP6.df"), 
           file = paste("/net/h2o/climphys1/sippels/_projects/ocean-cold-anomaly/data/02_trained_models/tos_predGMSST/", 
                        format(HadSST4_calendar_[date.ix], "%Y"), "-", format(HadSST4_calendar_[date.ix], "%m"), ".RData", sep=""))
    }
    ...
    # 4.6 Predict GMMSAT:  
    {
      ...
      # save models for given time step:
      save(list = c("mod_p0", "mod_p1", "mod_gta", "CMIP6.df"), 
           file = paste("/net/h2o/climphys1/sippels/_projects/ocean-cold-anomaly/data/02_trained_models/tos_predGMMSAT/", 
                        format(HadSST4_calendar_[date.ix], "%Y"), "-", format(HadSST4_calendar_[date.ix], "%m"), ".RData", sep=""))
    }
    ...
    # 4.11 Predict IndianOcean:  
    {
      ...
      # save models for given time step:
      save(list = c("mod_p0", "mod_p1", "mod_gta", "CMIP6.df"), 
           file = paste("/net/h2o/climphys1/sippels/_projects/ocean-cold-anomaly/data/02_trained_models/tos_predIndianOcean/", 
                        format(HadSST4_calendar_[date.ix], "%Y"), "-", format(HadSST4_calendar_[date.ix], "%m"), ".RData", sep=""))
    ...
    # 4.12 Predict WPacific:  
    {
      ...
      # save models for given time step:
      save(list = c("mod_p0", "mod_p1", "mod_gta", "CMIP6.df"), 
           file = paste("/net/h2o/climphys1/sippels/_projects/ocean-cold-anomaly/data/02_trained_models/tos_predWPacific/", 
                        format(HadSST4_calendar_[date.ix], "%Y"), "-", format(HadSST4_calendar_[date.ix], "%m"), ".RData", sep=""))
      rm(mod0., mod_p0, mod1., mod_p1, mod_gta)
    }
    ...
    # 4.14 Predict WAtlantic:  
    {
      ...
      # save models for given time step:
      save(list = c("mod_p0", "mod_p1", "mod_gta", "CMIP6.df"), 
           file = paste("/net/h2o/climphys1/sippels/_projects/ocean-cold-anomaly/data/02_trained_models/tos_predWAtlantic/", 
                        format(HadSST4_calendar_[date.ix], "%Y"), "-", format(HadSST4_calendar_[date.ix], "%m"), ".RData", sep=""))
      rm(mod0., mod_p0, mod1., mod_p1, mod_gta)
    }
