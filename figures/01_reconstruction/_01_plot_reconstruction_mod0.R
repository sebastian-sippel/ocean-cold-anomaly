...
# ------------------------------------------------------------------------------------
{
  ...
  GMST.tas_land = get.df(Y = OBS.tas_land_$GMST_FM$ann$mod_p0, f = rowMeans(CMIP6.GMST.f, na.rm=T), years = 1850:2020, center = T, ens.ix = 94:200, years.DA = 1850:2014)
  ...
  GMST.ERSSTv4 = get.df(Y = ERSSTv4.annual$GMST_FM_mod_p0_1se, f = rowMeans(CMIP6.GMST.f, na.rm=T), years = ERSSTv4.annual$Year, center = T, ens.ix = NULL, years.DA = 1850:2014)
  ...
  GMST.hybrid36 = get.df(Y = colMedians(OBS_hybrid36.tos_$GMST_FM$ann$mod_p0), f = CMIP6.MMM, years = 1850:2016, center = T, ens.ix = NULL, years.DA = 1850:2020)
  GMST.tas_sea = get.df(Y = colMedians(OBS_CLASSNMAT.tas_$GMST_FM$ann$mod_p0), f = CMIP6.MMM, years = 1880:2019, center = T, ens.ix = NULL, years.DA = 1850:2020)
...
# mod_p1:
pdf(file = "01_GMST_land_vs_ocean_reconstruction_mod_p0.pdf", width = 8, height=10)
{
...
# plot(OBS.tas_land$GMST_FM$ann$mod_p0, GMST.tas_land$mod_p1_min_50)
# plot(OBS.tos$GMST_FM$ann$mod_p0, GMST.tos$mod_p1_min_50)


# mod_p1:
pdf(file = "01_GMST_land_vs_ocean_reconstruction_mod_p0_exp.pdf", width = 8, height=11)
{
...
# mod_p1:
pdf(file = "01_GMST_land_vs_ocean_reconstruction_mod_p0_small.pdf", width = 8, height=5)
{
  par(mfrow=c(1, 1), mar=c(2,4,1,4))
