...
png(filename = "04_illustration_scatterplot.png", width = 8, height = 7, units = "in", res = 200)
{
  ...
  load("/net/h2o/climphys1/sippels/_projects/global_mean_reconstr_v3/data/03_processedCMIP6_reconstr/CMIP6.tas_land_CMIP6_illustration_v5.RData")
  ...
  load("/net/h2o/climphys1/sippels/_projects/global_mean_reconstr_v3/data/03_processedCMIP6_reconstr/CMIP6.tos_CMIP6_illustration_v5.RData")
  obs = CMIP_illustration_1895$Y_ann
  pred = CMIP_illustration_1895$Yhat_ann_p1_pt1
  # obs1 = obs[which(!is.na(pred))]
  # pred1 = lm(obs ~ pred)$fitted  
