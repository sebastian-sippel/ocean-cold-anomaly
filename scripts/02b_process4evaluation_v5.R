...
# screen -S process4evaluation_v5
# screen -S tos_process4evaluation_v5
...
# -------------------------------------------------------
{
  ...
  {      
    ...
    save(list = c("OBS.tos_"), 
         file = "/net/h2o/climphys1/sippels/_projects/global_mean_reconstr_v3/data/03_processedOBS_reconstr/OBS.tos_v5.RData")
  }
  ...
  # ---------------------------------------------------------------
  {
    ...
    save(list = c("CMIP6.tos.df"), 
         file = "/net/h2o/climphys1/sippels/_projects/global_mean_reconstr_v3/data/03_processed_CMIP6_4evaluation/CMIP6.tos.df_v5.RData")
  }
  ...
  # ---------------------------------------------------------------
  {
    ...
    save(list = c("CMIP6.tos_all.df"), 
         file = "/net/h2o/climphys1/sippels/_projects/global_mean_reconstr_v3/data/03_processedCMIP6_reconstr/CMIP6.tos_all.df_v5.RData")
  }
  ...
  # ---------------------------------------------------------------
  {
    ...
    CMIP_illustration_1895$Y_ann = rowMeans(sapply(X = 1:12, FUN = function(mon.ix) CMIP6.tos.df$mon[[mon.ix]]$Y[[cur.name]]))               # 15626 entries...  -> works!!!
      ...
      save(list = c("CMIP_illustration_1895", "CMIP_illustration_1995"), 
           file = "/net/h2o/climphys1/sippels/_projects/global_mean_reconstr_v3/data/03_processedCMIP6_reconstr/CMIP6.tos_CMIP6_illustration_v5.RData")
  }
}
