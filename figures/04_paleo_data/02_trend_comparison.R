...
file.name = "04b_ocean2k_period_diff.pdf"
ylim = c(-0.6, 0.4)
xlim = c(0,8)
trend.ix = 9
...
pdf(file = file.name, width = 5, height = 3)
{
    ...
    
    {
      ...
      # points(x = at - 0.2, y = hybrid_36m_Tropics_ann.trends[9], pch = 25, bg = make.transparent.color("darkgoldenrod4", 250), cex = 1.5)
      ...
      # points(x = at - 0.2, y = hybrid_36m_WPacific_ann.trends[9], pch = 25, bg = make.transparent.color("darkgoldenrod4", 250), cex = 1.5)
      ...
      # points(x = at - 0.2, y = hybrid_36m_IndianOcean_ann.trends[9], pch = 25, bg = make.transparent.color("darkgoldenrod4", 250), cex = 1.5)
      # points(x = at + 0.2, y = BEST_Indian_Ocean.trend[9], pch = 25, bg = make.transparent.color("darkblue", 250), cex = 1.5)
      # vioplot(x = OBS.IndianOcean_tos.trends[trend.ix,], at = at + 0.1, wex = 0.5, col = "lightblue", side = "right", add = T, pchMed = 21, yaxt="n")
      # vioplot(x = OBS.IndianOcean_tos.trends[trend.ix,], col = make.transparent.color("white", alpha = 0), border = NA, side="right", at = at + 0.1, wex = 1.5, 
      #        axes = F, add = T, pchMed = 21)
      ...
      # points(x = at - 0.2, y = hybrid_36m_WAtlantic_ann.trends[9], pch = 25, bg = make.transparent.color("darkgoldenrod4", 250), cex = 1.5)
      # points(x = at + 0.2, y = BEST_WAtlantic.trend[9], pch = 25, bg = make.transparent.color("darkblue", 250), cex = 1.5)
      # vioplot(x = OBS.WAtlantic_tos.trends[trend.ix,], at = at + 0.1, wex = 0.5, col = "lightblue", side = "right", add = T, pchMed = 21, yaxt="n")
      # vioplot(x = OBS.WAtlantic_tos.trends[trend.ix,], col = make.transparent.color("white", alpha = 0), border = NA, side="right", at = at + 0.1, wex = 1.5, 
      #        axes = F, add = T, pchMed = 21)
    ...
    legend("bottomleft", c("Land-based reconstruction \n of ocean region", "HadSST4, region average", "Tierney et al., 2015, \n 'Best reconstruction'"), 
           col = c(make.transparent.color("orange", 75), 
